...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/xqqman/x-ui/master/install.sh)
```

For full documentation, please visit the [project Wiki](https://github.com/xqqman/x-ui/wiki).
